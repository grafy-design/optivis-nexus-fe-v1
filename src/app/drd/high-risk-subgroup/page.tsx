    ...
    <AppLayout headerType="drd" drdStep={1} scaleMode="none">
        ...
        <div className="drd-content-row gap-1">
         ...
         {/* 오른쪽 상위 배경 카드: selection-bg.png → 안에 흰색 테이블 카드 */}
            ...
            <div className="shrink-0 flex items-center justify-between pl-[4px] pr-[4px] h-[40px] pt-0 pb-0 pr-0">
              <h2 className="font-['Inter'] font-semibold text-[24px] leading-[1.2] text-neutral-30 tracking-[-0.72px] m-0">
                Load Subgroup
              </h2>
              ...
              <div className="bg-white rounded-[24px] flex flex-col overflow-hidden h-full">
                ...
                <div className="flex items-center shrink-0 border-b border-neutral-90 py-[12px] px-0">
                  ...
                  <div className="flex items-center px-[10px] w-[17.94%] h-full border-l border-neutral-90 shrink-0">
                    <span className="font-['Inter'] font-semibold text-[12px] leading-[1.1] text-[var(--text-secondary)] tracking-[-0.36px]">Set Name</span>
                  </div>
                  <div className="flex items-center px-[10px] w-[20.04%] h-full border-l border-neutral-90 shrink-0">
                    <span className="font-['Inter'] font-semibold text-[12px] leading-[1.1] text-[var(--text-secondary)] tracking-[-0.36px]">Feature</span>
                  </div>
                  <div className="flex items-center px-[10px] w-[14.31%] h-full border-l border-neutral-90 shrink-0">
                    <span className="font-['Inter'] font-semibold text-[12px] leading-[1.1] text-[var(--text-secondary)] tracking-[-0.36px]">Condition</span>
                  </div>
                  <div className="flex items-center px-[10px] w-[11.45%] h-full border-l border-neutral-90 shrink-0">
                    <span className="font-['Inter'] font-semibold text-[12px] leading-[1.1] text-[var(--text-secondary)] tracking-[-0.36px]">Month</span>
                  </div>
                  <div className="flex items-center px-[10px] w-[11.45%] h-full border-l border-neutral-90 shrink-0">
                    <span className="font-['Inter'] font-semibold text-[12px] leading-[1.1] text-[var(--text-secondary)] tracking-[-0.36px]">Slope</span>
                  </div>
                  <div className="flex items-center px-[10px] w-[17.18%] h-full border-l border-neutral-90 shrink-0">
                    <span className="font-['Inter'] font-semibold text-[12px] leading-[1.1] text-[var(--text-secondary)] tracking-[-0.36px]">Status</span>
                  </div>
                  <div className="flex items-center px-[10px] flex-1 h-full border-l border-neutral-90">
                    <span className="font-['Inter'] font-semibold text-[12px] leading-[1.1] text-[var(--text-secondary)] tracking-[-0.36px]">Date</span>
                  </div>
                </div>
                ...
                <div className="flex-1 overflow-y-auto scrollbar-hide flex flex-col">
                  ...
                  <div className={`flex flex-col shrink-0 ${ckd1HasSel || ckd1Open ? "border-solid" : "border-b border-neutral-60 border-solid"}`} style={{ background: ckd1HasSel ? "rgba(243,238,255,0.6)" : ckd1Open ? "#fbfbfc" : "white", ...(ckd1HasSel ? { borderTop: "1px solid rgba(58,17,216,0.6)", borderBottom: "1px solid rgba(58,17,216,0.6)" } : ckd1Open ? { borderTop: "1px solid #919092", borderBottom: "1px solid #ADADAD" } : {}) }}>
                    <div className={`flex items-stretch py-[6px] overflow-clip cursor-pointer${ckd1HasSel ? " [&_span]:text-neutral-20" : ""}`} onClick={() => toggleRow("ckd1")}>
                      ...
                      <div className="flex items-center px-[10px] w-[17.94%] border-l border-neutral-90 shrink-0">
                        <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px] flex-1 min-w-0">
                          CKD 1 Stage
                        </span>
                      </div>
                      <div className="flex items-center px-[10px] w-[20.04%] border-l border-neutral-90 shrink-0">
                        <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px]">
                          eGFR
                        </span>
                      </div>
                    ...
                    {expandedRows.has("ckd1") && (
                      <>
                        ...
                        <div className={`flex items-center py-[16px] overflow-clip border-solid cursor-pointer ${isSel ? "[&>div]:border-neutral-90 [&_span]:text-neutral-20" : "[&>div]:border-neutral-90"}`} style={{ borderTop: `1.5px solid ${ckd1HasSel ? "#3a11d8" : "#ADADAD"}`, background: "transparent", opacity: 1 }} onClick={() => selectSubRow("ckd1-slow")}>
                          <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] shrink-0">
                          ...
                          <div className="flex items-center px-[10px] w-[17.94%] border-l shrink-0">
                            <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px] flex-1 min-w-0">Slow</span>
                          </div>
                          <div className="flex items-center px-[10px] w-[20.04%] border-l shrink-0">
                            <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px]">eGFR</span>
                          </div>
                          <div className="flex items-center px-[10px] w-[14.31%] border-l shrink-0">
                            <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px]">{`> 90`}</span>
                          </div>
                          <div className="flex items-center px-[10px] w-[11.45%] border-l shrink-0">
                            <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px]">36</span>
                          </div>
                          <div className="flex items-center px-[10px] w-[11.45%] border-l shrink-0">
                            <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px]">2</span>
                          </div>
                          <div className="flex items-center px-[10px] w-[17.18%] border-l shrink-0">
                            <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px]">n=1,200</span>
                          </div>
                        ...
                        <div className={`flex items-center py-[16px] overflow-clip border-solid cursor-pointer ${isSel ? "[&>div]:border-neutral-90 [&_span]:text-neutral-20" : "[&>div]:border-neutral-90"}`} style={{ borderTop: "1.5px solid #D8D7D9", background: "transparent", opacity: 1 }} onClick={() => selectSubRow("ckd1-rapid")}>
                          <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] shrink-0">
                            <RadioButton checked={isSel} onChange={() => selectSubRow("ckd1-rapid")} size={16} />
                          </div>
                          <div className="flex items-center px-[10px] w-[17.94%] border-l shrink-0">
                            <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px] flex-1 min-w-0">Rapid</span>
                          </div>
                          <div className="flex items-center px-[10px] w-[20.04%] border-l shrink-0">
                            <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px]">eGFR</span>
                          </div>
                          ...
                          <div className="flex items-center px-[10px] w-[17.18%] border-l shrink-0">
                            <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px]">n=360</span>
                          </div>
                          <div className="flex items-center px-[10px] flex-1 border-l" />
                        </div>
                        ); })()}
                  ...
                  <div className={`flex flex-col shrink-0 ${ckd2HasSel || ckd2Open ? "border-solid" : "border-b border-neutral-60 border-solid"}`} style={{ background: ckd2HasSel ? "rgba(243,238,255,0.6)" : ckd2Open ? "#fbfbfc" : "white", ...(ckd2HasSel ? { borderTop: "1px solid rgba(58,17,216,0.6)", borderBottom: "1px solid rgba(58,17,216,0.6)" } : ckd2Open ? { borderTop: "1px solid #919092", borderBottom: "1px solid #ADADAD" } : {}) }}>
                    <div className={`flex items-stretch py-[6px] overflow-clip cursor-pointer${ckd2HasSel ? " [&_span]:text-neutral-20" : ""}`} onClick={() => toggleRow("ckd2")}>
                      <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] shrink-0">
                        <div className="w-[20px] h-[20px] flex items-center justify-center">
                      ...
                      <div className="flex items-center px-[10px] w-[17.94%] border-l border-neutral-90 shrink-0">
                        <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px] flex-1 min-w-0">CKD 2 Stage</span>
                      </div>
                      <div className="flex items-center px-[10px] w-[20.04%] border-l border-neutral-90 shrink-0">
                        <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px]">eGFR</span>
                      </div>
                      <div className="flex items-center px-[10px] w-[14.31%] border-l border-neutral-90 shrink-0">
                        <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px]">≤ 60 ≤ 90</span>
                      </div>
                      <div className="flex items-center px-[10px] w-[11.45%] border-l border-neutral-90 shrink-0">
                        <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px]">36</span>
                      </div>
                      <div className="flex items-center px-[10px] w-[11.45%] border-l border-neutral-90 shrink-0">
                        <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px]">3</span>
                      </div>
                      <div className="flex items-center px-[10px] w-[17.18%] border-l border-neutral-90 shrink-0">
                        <p className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px] m-0">
                          <span className="text-secondary-60">NG</span>{` (n min=150)`}
                        </p>
                      </div>
                      <div className="flex items-center px-[10px] flex-1 border-l border-neutral-90">
                        <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px]">2025/12/25 17:00:01</span>
                      </div>
                    </div>
                    {expandedRows.has("ckd2") && (
                      <>
                        ...
                        <div className={`flex items-center py-[16px] overflow-clip border-solid cursor-pointer ${isSel ? "[&>div]:border-neutral-90 [&_span]:text-neutral-20" : "[&>div]:border-neutral-90"}`} style={{ borderTop: `1.5px solid ${ckd2HasSel ? "#3a11d8" : "#ADADAD"}`, background: "transparent", opacity: 1 }} onClick={() => selectSubRow("ckd2-slow")}>
                          <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] shrink-0">
                          ...
                          <div className="flex items-center px-[10px] w-[14.31%] border-l shrink-0">
                            <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px]">{`> 60`}</span>
                          </div>
                          <div className="flex items-center px-[10px] w-[11.45%] border-l shrink-0">
                            <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px]">36</span>
                          </div>
                        ...
                        <div className={`flex items-center py-[16px] overflow-clip border-solid cursor-pointer ${isSel ? "[&>div]:border-neutral-90 [&_span]:text-neutral-20" : "[&>div]:border-neutral-90"}`} style={{ borderTop: "1.5px solid #D8D7D9", background: "transparent", opacity: 1 }} onClick={() => selectSubRow("ckd2-rapid")}>
                          <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] shrink-0">
                  ...
                  <div className={`flex flex-col shrink-0 ${set1HasSel || set1Open ? "border-solid" : "border-b border-neutral-60 border-solid"}`} style={{ background: set1HasSel ? "rgba(243,238,255,0.6)" : set1Open ? "#fbfbfc" : "white", ...(set1HasSel ? { borderTop: "1px solid rgba(58,17,216,0.6)", borderBottom: "1px solid rgba(58,17,216,0.6)" } : set1Open ? { borderTop: "1px solid #919092", borderBottom: "1px solid #ADADAD" } : {}) }}>
                    <div className={`flex items-stretch py-[6px] overflow-clip cursor-pointer${set1HasSel ? " [&_span]:text-neutral-20" : ""}`} onClick={() => toggleRow("set1")}>
                      <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] shrink-0">
                        <div className="w-[20px] h-[20px] flex items-center justify-center">
                      ...
                      <div className="flex items-center px-[10px] w-[17.94%] border-l border-neutral-90 shrink-0">
                        <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px]">Set 1</span>
                      </div>
                      <div className="flex items-center px-[10px] w-[20.04%] border-l border-neutral-90 shrink-0">
                        <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px]">HbA1c</span>
                      </div>
                      <div className="flex items-center px-[10px] w-[14.31%] border-l border-neutral-90 shrink-0" />
                      <div className="flex items-center px-[10px] w-[11.45%] border-l border-neutral-90 shrink-0" />
                      <div className="flex items-center px-[10px] w-[11.45%] border-l border-neutral-90 shrink-0" />
                    ...
                    {expandedRows.has("set1") && (
                      <>
                        ...
                        <div className={`flex items-center py-[16px] overflow-clip border-solid cursor-pointer ${isSel ? "[&>div]:border-neutral-90 [&_span]:text-neutral-20" : "[&>div]:border-neutral-90"}`} style={{ borderTop: `1.5px solid ${set1HasSel ? "#3a11d8" : "#ADADAD"}`, background: "transparent", opacity: 1 }} onClick={() => selectSubRow("set1-slow")}>
                          <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] shrink-0">
                        ...
                        <div className={`flex items-center py-[16px] overflow-clip border-solid cursor-pointer ${isSel ? "[&>div]:border-neutral-90 [&_span]:text-neutral-20" : "[&>div]:border-neutral-90"}`} style={{ borderTop: "1.5px solid #D8D7D9", background: "transparent", opacity: 1 }} onClick={() => selectSubRow("set1-rapid")}>
                          <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] shrink-0">
                  ...
                  <div className={`flex flex-col shrink-0 ${set4HasSel || set4Open ? "border-solid" : "border-b border-neutral-60 border-solid"}`} style={{ background: set4HasSel ? "rgba(243,238,255,0.6)" : set4Open ? "#fbfbfc" : "white", ...(set4HasSel ? { borderTop: "1px solid rgba(58,17,216,0.6)", borderBottom: "1px solid rgba(58,17,216,0.6)" } : set4Open ? { borderTop: "1px solid #919092", borderBottom: "1px solid #ADADAD" } : {}) }}>
                    <div className={`flex items-stretch py-[6px] overflow-clip cursor-pointer${set4HasSel ? " [&_span]:text-neutral-20" : ""}`} onClick={() => toggleRow("set4")}>
                      <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] shrink-0">
                        <div className="w-[20px] h-[20px] flex items-center justify-center">
                      ...
                      <div className="flex items-center px-[10px] w-[17.94%] border-l border-neutral-90 shrink-0">
                        <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px]">Set 4</span>
                      </div>
                      <div className="flex items-center px-[10px] w-[20.04%] border-l border-neutral-90 shrink-0">
                        <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-neutral-40 tracking-[-0.75px]">HbA1c</span>
                      </div>
                    ...
                    {expandedRows.has("set4") && (
                      <>
                        ...
                        <div className={`flex items-center py-[16px] overflow-clip border-solid cursor-pointer ${isSel ? "[&>div]:border-neutral-90 [&_span]:text-neutral-20" : "[&>div]:border-neutral-90"}`} style={{ borderTop: `1.5px solid ${set4HasSel ? "#3a11d8" : "#ADADAD"}`, background: "transparent", opacity: 1 }} onClick={() => selectSubRow("set4-slow")}>
                          <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] shrink-0">
                        ...
                        <div className={`flex items-center py-[16px] overflow-clip border-solid cursor-pointer ${isSel ? "[&>div]:border-neutral-90 [&_span]:text-neutral-20" : "[&>div]:border-neutral-90"}`} style={{ borderTop: "1.5px solid #D8D7D9", background: "transparent", opacity: 1 }} onClick={() => selectSubRow("set4-rapid")}>
                          <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] shrink-0">
      ...
      {showSubgroupModal && (
        ...
        >
          ...
          >
            {/* 글래스 배경 */}
            <div aria-hidden="true" className="rounded-[24px] absolute inset-0 pointer-events-none">
