...
export function TSIFeatureDiseaseProgressionPanel({
  chartData,
  rows,
  seriesLabels,
  seriesColors,
  ...
  return (
    <div className="flex min-h-[656px] w-full flex-1 flex-shrink-0 flex-col rounded-[16px] bg-[#ECECF1] p-4">
      ...
      <div className="mt-3 min-h-[430px] flex-1">
        <MultiLineWithErrorBar
          dataGroup={chartData}
