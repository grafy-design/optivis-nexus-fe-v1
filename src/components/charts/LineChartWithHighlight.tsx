...
export const LineChartWithHighlight: React.FC<LineChartWithHighlightProps> = ({
  ...
  const optivisY = optivisHighlightIndex >= 0 && optivisHighlightIndex < optivisData.length
    ? optivisData[optivisHighlightIndex][1]
    : null;
  
  const traditionalHighlightIndex = optivisY !== null
    ? findClosestIndexByY(traditionalData, optivisY)
    : -1;
            ...
            data: [
              {
                ...
                label: { show: false },
                lineStyle: { color: optivisColor, type: "solid", width: 2, opacity: 1 },
              },
              {
                yAxis: optivisPoint[1],
                label: { show: false },
                lineStyle: { color: "#7654F0", type: [4, 3] as any, width: 1.5, opacity: 0.8 },
              },
            ],
            z: 5,
          }
            ...
            data: [
              {
                ...
                label: { show: false },
                lineStyle: { color: traditionalColor, type: "solid", width: 2, opacity: 1 },
              },
            ],
            z: 5,
          }
    ...
    <ReactECharts
      option={{
        ...
        xAxis: {
          ...
          nameTextStyle:
            xAxisConfig.nameTextStyle ?? { fontSize: 12, color: "#666" },
          axisLine: {
            show: showAxes,
            ...(showAxes && { lineStyle: { color: "#999" } }),
          },
          axisTick: { show: showTicks },
          axisLabel: { show: showTicks },
          splitLine: { show: showGrid, lineStyle: { color: "#e0e0e0", type: "dashed" } },
        ...
        yAxis: {
          ...
          nameTextStyle:
            yAxisConfig.nameTextStyle ?? { fontSize: 12, color: "#666" },
          axisLine: {
            show: showAxes,
            ...(showAxes && { lineStyle: { color: "#999" } }),
          },
