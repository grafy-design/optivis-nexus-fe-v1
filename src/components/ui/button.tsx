...
export default function Button({
  ...
  const variants = {
    primary: "bg-primary text-white hover:bg-[#1a1a3e]",
    ghost: "bg-transparent hover:bg-gray-100",
    outline: "border border-gray-300 bg-transparent hover:bg-gray-50",
    glass: "bg-[rgba(36,36,36,0.3)] backdrop-blur-[10px] text-black hover:bg-[rgba(36,36,36,0.4)]",
    orange: "bg-secondary-60 text-white hover:bg-secondary-45 disabled:opacity-50 disabled:hover:bg-secondary-60",
