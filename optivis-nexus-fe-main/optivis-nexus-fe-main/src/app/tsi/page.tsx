...
export default function TSIPage() {
  ...
  const filteredData = attachedData.filter(
    (data) =>
      ...
      data.disease.toLowerCase().includes(searchKeyword.toLowerCase())
  );
  ...
  return (
    <AppLayout headerType="tsi" scaleMode="none">
      ...
      >
        <div
          className="relative h-full rounded-[36px] overflow-hidden min-h-0 flex-1"
          style={{
        ...
        >
          <div style={{ flexShrink: 0, padding: "0 4px" }}>
            ...
            >
              Simulation templates are provided to show the required input structure. Please review before
              proceeding.
            </span>
          </div>
          <div className="flex flex-1 min-h-0 flex-col overflow-hidden">
            <div className="relative flex flex-1 min-h-0 flex-col gap-6">
              {/* Header */}
              <div
                className="flex gap-4 min-h-[244px] max-[1470px]:min-h-[184px]"
                style={{ flex: "0.6 1 0%" }}
              >
                <div
                  className="flex flex-shrink-0 flex-col justify-between rounded-[24px] p-4 max-[1470px]:p-3"
                  style={{ backgroundColor: "#231f52", width: "266px", aspectRatio: "1 / 1" }}
                >
                  <div className="flex h-full flex-col justify-center gap-2 max-[1470px]:gap-1">
                    ...
                    <p className="px-0 text-center text-body4m text-[#aaaaad]">
                ...
                <div className="flex flex-1 flex-col items-center justify-center gap-6 rounded-[24px] bg-white px-0 pt-6 pb-3 min-h-[244px] max-[1470px]:min-h-[184px] max-[1470px]:gap-4 max-[1470px]:p-4">
                ...
                <div className="flex flex-col gap-[8px]">
                  <div className="rounded-[24px] h-[46px] bg-[#231f52] flex items-center">
                    <div
                      ...
                      style={{ fontSize: "14px", fontWeight: 600, letterSpacing: "-0.42px" }}
                    >
                  ...
                  <div className="flex min-h-[280px] flex-1 gap-0 overflow-hidden rounded-[18px] bg-white">
                            ...
                            {leftTableData.map((data, index) => (
                              ...
                              >
                                <div className="flex items-center gap-4">
                                  ...
                                  <span
                                    className="w-[106px] text-neutral-20"
                                    style={{ fontSize: "14px", fontWeight: 600, letterSpacing: "-0.42px" }}
                                  >
                                    {data.name}
                                  </span>
                                ...
                                <span
                                  className="w-[120px] text-neutral-20"
                                  style={{ fontSize: "14px", fontWeight: 600, letterSpacing: "-0.42px" }}
                                >
                                  {data.patients}
                                </span>
                                <span
                                  className="w-[200px] text-neutral-20"
                                  style={{ fontSize: "14px", fontWeight: 600, letterSpacing: "-0.42px" }}
                                >
                                  {data.disease}
                                </span>
                                <span
                                  className="w-[206px] text-neutral-20"
                                  style={{ fontSize: "14px", fontWeight: 600, letterSpacing: "-0.42px" }}
                                >
                                  {data.updateDate}
                                </span>
          ...
          <div className="flex justify-end">
            <button
              ...
              style={{
                ...
                border: "none",
                cursor: selectedData.size === 0 ? "not-allowed" : "pointer",
                fontFamily: "Inter",
                fontSize: 15,
                fontWeight: 600,
                color: "#ffffff",
