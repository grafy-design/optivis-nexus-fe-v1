  ...
  return (
    <Dialog.Root open={open} onOpenChange={handleOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="opacity-94 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[120] w-[calc(100%-32px)] max-w-[1120px] h-[calc(100%-32px)] max-h-[620px] p-0 border-0 bg-transparent">
          <VisuallyHidden.Root>
          ...
          <div className="relative w-full h-full">
            ...
            {/* Chart Section */}
            <div className="absolute bottom-6 left-6 right-6 top-[150px] z-10">
                          ...
                          ? [
                              {
                                ...
                                renderItem: (params: any, api: any) => {
                                  ...
                                  const barWidth = categoryGap * 0.8;
