...
export const MultiLineWithErrorBar = ({
  ...
  const option: EChartsOption = {
    tooltip: showTooltip
      ? {
          trigger: "axis",
          axisPointer: { lineStyle: { color: "#8f8ac4", type: "dashed" } },
          padding: [4, 6],
    ...
    xAxis: {
      ...
      axisLine: {
        show: true,
        onZero: xAxis?.onZero ?? true,
        lineStyle: {
          color: xAxis?.axisLineColor ?? sz?.axisLineColor ?? sz?.axisColor ?? "#9A9AA3",
          width: sz?.axisWidth ?? 1,
        },
      },
      axisTick: { show: false },
      axisLabel: {
    ...
    yAxis: {
      ...
      axisLine: {
        show: true,
        lineStyle: {
          color: yAxis?.axisLineColor ?? sz?.axisLineColor ?? sz?.axisColor ?? "#9A9AA3",
          width: sz?.axisWidth ?? 1,
        },
      },
      name: yAxis?.name,
