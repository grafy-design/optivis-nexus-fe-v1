...
export function RightPanel({
  ...
  const showCompareMetricDetails = isApplied && !isResultMasking;
    ...
    <div className="w-full h-full min-h-0">
      ...
      >
        <div className="flex flex-col w-full h-full p-0">
          ...
          <div className="flex items-center justify-between flex-shrink-0 mb-3 pl-[0px] pr-[4px]">
            {/* Tab Bar */}
                ...
                >
                  <div className="flex flex-col w-full h-full p-4">
                    ...
                    <div className="flex flex-col gap-1 mb-4 flex-shrink-0">
                      ...
                      <p className="text-body4 text-neutral-98">
                        Sample Size vs Enrollment Time
                      </p>
                      {isApplied &&
                        simulationData?.smallerSample?.percentage && (
                          <div className="flex items-center gap-1 mt-1">
              ...
              <div className="flex gap-4 flex-[2] min-h-0">
                ...
                >
                  <div className="flex flex-col w-full h-full p-4">
                    ...
                    {/* Chart Area */}
                    <div className="mt-auto bg-white/60 rounded-[12px] flex-1 min-h-0">
                      {activeTab === "compare" ? (
                        chartDataToUse &&
                      ...
                      {activeTab === "compare" ? (
                        ...
                        (() => {
                          ...
                          return chart ? (
                            <>
                              {(() => {
                                const isPowerNoLoss = chart.change === "No loss";
                                return (
                                  <>
                                    <div className="flex flex-col gap-1">
                                      <h3 className="text-body4 text-neutral-15">
                        ...
                        {simulationData?.reductionView?.charts?.map(
                          (chart, index) => {
                            ...
                            return (
                              <div
                                key={index}
                                className="flex h-full min-h-0 flex-col rounded-[16px] bg-[#f5f5f6] p-3"
                              >
                                <div className="flex items-start justify-between gap-2">
                                  <div className="flex flex-col gap-1.5">
                                    <span className="text-body2 text-[#1c1b1c]">
                                      {chart.label}
                                    </span>
                                    <div className="flex items-center gap-1">
                                      {!isPowerNoLoss && (
                                      ...
                                      <span className="text-h3 text-[#1b1b1b]">
                                        {chart.change}
                                      </span>
                                    </div>
                                  </div>
                                ...
                                <div className="mt-auto h-[140px] w-full">
                                  <ComparisonBarChart
                    ...
                    <div className="flex flex-col gap-2 h-full overflow-hidden">
                      ...
                      {chartDataToUse.smallerSample.optivis.length > 0 && (
                        <div className="flex flex-col gap-2 flex-1 min-h-0">
                          ...
                          <div className="bg-white rounded-[12px] flex-1 min-h-0">
                            <SmallerSampleChart
                              optivisData={chartDataToUse.smallerSample.optivis}
                              traditionalData={
                                chartDataToUse.smallerSample.traditional
